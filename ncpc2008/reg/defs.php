<?
    ...
    function quoteForDB($str) {
        global $DBHANDLE;
        /* convert to UTF-8 */
        #$str = mb_convert_encoding($str, "UTF-8", array("ISO-8859-1"));
        $str = utf8_encode($str);
        return $DBHANDLE->quote($str);
    }

    function DBToForm($str) {
        #_p($str);
        #$str = mb_convert_encoding($str, "ISO-8859-1", array("UTF-8"));
        $str = utf8_decode($str);
        #_p($str);
        return $str;    
    }
    ...
    $SCHOOLINFO = array(
        ...
        'au'       => array('country' => 'dk',
                            ...
                            'email' => 'thomasm@madalgo.au.dk'),
        'diku'     => array('country' => 'dk',
                            'nosite' => TRUE,
                            'name' => 'Technical University of Denmark',
                            'email' => 'ksk@netcompany.com'),
        ...
        'hiof'     => array('country' => 'no',
                            'nosite' => TRUE,
                            'name' => '&Oslash;stfold University College',
                            'email' => $OTHER_EMAIL),
